"use strict";
Object.defineProperty(typeof exports != 'undefined' ? exports : typeof globalThis != 'undefined' ? globalThis : self, "recaptcha_assessment", {
  value: Object.defineProperty({
    default: function (opts) {
      var u = 'undefined', s = 'script', f = 'function', d = document;

      var state = {
        siteKey: opts.siteKey,
        action: opts.action || 'page_view',
        sendEvent: typeof opts.sendEvent === u ? false : opts.sendEvent,
        sendContext: typeof opts.sendContext === u ? true : opts.sendContext,
              ...
              gr.ready(function () {
                ...
                gr.execute(state.siteKey, { action: state.action }).then(function (token) {
                  ...
                  if (state.sendEvent && typeof window[trackerfn] === f) {
                    window[trackerfn]('trackSelfDescribingEvent', { event: payload() });
                  }
